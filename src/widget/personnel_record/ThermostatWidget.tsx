...
const Loader = () => {
  ...
  return (
    <StyledWrapper onClick={() => navigate("/registro_personal")} style={{ cursor: "pointer" }}>
      <div className="text"><b>REGISTRO DE PERSONAL</b></div>
      <svg xmlns="http://www.w3.org/2000/svg" height={200} width={200}>
        <g style={{ order: -1 }}>
          <polygon transform="rotate(45 100 100)" strokeWidth={1} stroke="#ac10d3ff" fill="none" points="70,70 148,50 130,130 50,150" id="bounce" />
          <polygon transform="rotate(45 100 100)" strokeWidth={1} stroke="#ac10d3ff" fill="none" points="70,70 148,50 130,130 50,150" id="bounce2" />
