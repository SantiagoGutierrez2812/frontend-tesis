...
import ProfileModal from "../components/ProfileModal"; // 👈 importa el nuevo modal
...
export default function MapaFondo() {
  ...
  const [showProfileModal, setShowProfileModal] = useState(false); // 👈 controla el modal
